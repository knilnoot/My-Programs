...
public class CrazyMan extends Player{
    ...
    public CrazyMan (float x, float y) {
        this.x = x;
        this.y = y;
        xSpawn = x;
        ySpawn = y;
        ...
        spriteNumber = 0;
        currentMove = new MIdle();
        sprites.add(new Sprite("Sprites/idleLeft/", 4));
        sprites.add(new Sprite("Sprites/runningLeft/", 2));
        sprites.add(new Sprite("Sprites/dancingGuy/", 6));
        sprites.add(new Sprite("Sprites/jumpLeft/", 1));
        sprites.add(new Sprite("Sprites/fallingLeft/", 3));
        sprites.add(new Sprite("Sprites/throwLeft/", 2));
        sprites.add(new Sprite("Sprites/spinAttack/", 1));
        sprites.add(new Sprite("Sprites/helplessLeft/", 2));
    ...
    private void updateSprite() {
        if (spriteNumber >= sprites.size() || spriteNumber < 0)
            spriteNumber = 0;
        if (airborne && currentMove instanceof MIdle)
            spriteNumber = 4;
        if (currentMove instanceof MThrowLollipop)
            spriteNumber = 5;
        if (currentMove instanceof MPoke)
